...
import at.rieder.secureqr.app.camera.open.OpenCameraInterface;
...
public final class CameraManager {
    ...
    /**
     * Convenience method for {@link at.rieder.secureqr.app.activities.ScanQRActivity}
     */
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int size = findDesiredDimensionInRange(screenResolution.x, MIN_FRAME_WIDTH, MAX_FRAME_WIDTH);
