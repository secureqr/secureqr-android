...
public final class ScanQRActivityHandler extends Handler {
    ...
    private static final String TAG = ScanQRActivityHandler.class.getSimpleName();
    ...
    ScanQRActivityHandler(ScanQRActivity activity) {
        ...
        this.cameraManager = ComponentAccessor.getInstance().getCameraManager();
